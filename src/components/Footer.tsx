...
const Footer = ({ dict }: { dict: any }) => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-10 px-6 text-center mt-auto">
      {/* Logo Section */}
      ...
      {/* Social Media Icons */}
      <div className="flex justify-center items-center gap-6 mb-6" data-aos="fade-up" data-aos-delay="200">
        <a
          href=""
          target="_blank"
      ...
      {/* Newsletter Section */}
      <h2 className="text-xl font-bold mb-4" data-aos="fade-up" data-aos-delay="400">
        {dict.footer?.newsletterTitle || "Newsletter Signup"}
      </h2>
      <p className="mb-6 text-gray-300" data-aos="fade-up" data-aos-delay="500">
        {dict.footer?.newsletterDescription || "Stay informed about the upcoming phases of WellFit and the release of our whitepapers!"}
      </p>

      <form className="flex justify-center items-center gap-4 mb-8" data-aos="fade-up" data-aos-delay="600">
        <input
          type="email"
