  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row items-center gap-8">
        ...
        {/* Text Section */}
        <div className="flex-1 text-gray-800" data-aos="fade-right">
          {/* Logo Section */}
          ...
          {/* Paragraphs */}
          <p className="text-base sm:text-base leading-relaxed mb-4" data-aos="fade-up">
          ...
          <p className="text-base sm:text-base leading-relaxed" data-aos="fade-up">
